export const metadata = {
  title: "Privacy Policy | Tech Gears Finds4You",
...
export default function PrivacyPolicy() {
  return (
    <main className="max-w-4xl mx-auto px-6 py-10 text-gray-800 dark:text-gray-200">
      <h1 className="text-3xl font-bold mb-6 text-center text-gray-900 dark:text-white">Privacy Policy</h1>
      ...
      <div className="space-y-8 leading-relaxed">
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-1">
            <li>
              Basic usage data such as pages visited and time spent on the blog (via Google Analytics or Vercel
              Analytics)
            </li>
            <li>Information you voluntarily provide via contact forms (name, email, etc.)</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p>
            We participate in the <strong>Amazon Services LLC Associates Program</strong>, which allows us to earn a
            commission by linking to Amazon.com and related sites. These links{" "}
            <strong>do not cost you anything extra</strong>, but help support the blog.
          </p>
        ...
        <section>
          ...
          <p>
            This website may use cookies to analyze traffic and provide a better user experience. You can disable
        ...
        <section>
          ...
          <p>
            Our website may contain links to external websites, especially Amazon. We are not responsible for the
        ...
        <section>
          ...
          <p>If you have any questions about this policy, feel free to contact us at:</p>
          <p>
            📧{" "}
